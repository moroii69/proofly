...
export const TeamSection = () => {
    const teamList: TeamProps[] = [
        ...
        {
            imageUrl: "https://i.imgur.com/TcoZO6R.jpeg",
            firstName: "Mohammed",
            lastName: "Faheem",
        ...
        {
            imageUrl: "https://i.imgur.com/xRYoAda.jpeg",
            firstName: "Mohd",
            lastName: "Abrar",
        ...
        {
            imageUrl: "https://i.imgur.com/pRIsUmC.jpeg",
            firstName: "Abdul",
            lastName: "Raqueeb",
        ...
        {
            imageUrl: "https://i.imgur.com/WfKUY5Z.jpeg",
        ...
        <section id="team" className="container px-4 py-16 sm:py-24">
            <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                    We&apos;re a committed team of professionals focused on
                    delivering innovative and accurate solutions for health
                    prediction.
                </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-12">
                {teamList.map(
                    (
                        ...
                        <Card
                            key={index}
                            className="bg-muted/60 dark:bg-card overflow-hidden group/card hover:shadow-lg transition-all duration-300"
                        >
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="bg-muted/60 p-6 rounded-lg">
                    ...
                    <p className="text-muted-foreground mb-4">
                        ...
                        join our team. Check out our open positions or send us
                        your resume.
                    </p>
                    <Link
                        href="https://forms.gle/V5QSr548j3Q6eyPu5"
                        target="_blank"
                ...
                <div className="bg-muted/60 p-6 rounded-lg">
                    ...
                    <p className="text-muted-foreground mb-4">
                        Have questions or want to learn more about our team?
