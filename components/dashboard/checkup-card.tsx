...
export function NextCheckupCard() {
    ...
    const [daysUntilCheckup, setDaysUntilCheckup] = useState<number | null>(
        null
    );
    ...
    useEffect(() => {
        ...
        const unsubscribeFuture = onSnapshot(
            futureCheckupsQuery,
            (snapshot) => {
                if (!snapshot.empty) {
    ...
    const calculateRecommendedDate = (metrics: MetricData[]) => {
        ...
        metrics.forEach((metric) => {
            ...
            if (
                (metric.metricType === "bloodPressure" && value > 140) ||
            ...
            if (
                (metric.metricType === "bloodPressure" && value > 180) ||
                            ...
                            <>
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center justify-between">
                                            <div className="text-2xl font-bold">
                                                {nextCheckup
                                                    ? nextCheckup.toLocaleDateString()
                                ...
                                {lastCheckup && (
                                    <div className="flex items-center text-sm text-muted-foreground">
                                        ...
                                        Last checkup:{" "}
                                        {lastCheckup.toLocaleDateString()}
                                    </div>
                                )}
                                ...
                                {urgency === "urgent" && (
                                    <Alert variant="destructive">
                                        ...
                                        <AlertDescription className="ml-2">
                                            Urgent: Schedule recommended within
                                            48 hours based on your health
                                            metrics
                                        </AlertDescription>
                                    </Alert>
                                )}
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="space-y-4 py-4">
                    ...
                    <Button
                        ...
                        className="w-full"
                        variant={
                            urgency === "urgent" ? "destructive" : "default"
                        }
                    >
                        {selectedDate
