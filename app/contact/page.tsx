...
const generateRandomLastIncident = () => {
    ...
    const time =
        Math.floor(
            Math.random() *
                (unit === "minutes" ? 59 : unit === "hours" ? 23 : 30)
        ) + 1;
    return time === 1
        ? `${time} ${unit.slice(0, -1)} ago`
        : `${time} ${unit} ago`;
};
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <p className="text-muted-foreground">
                                Built with Next.js 14, Express, and Firebase.
                                Using modern web technologies for optimal
                                performance.
                            </p>
                        </CardHeader>
