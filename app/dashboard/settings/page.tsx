...
export default function SettingsPage() {
    ...
    const handleResetData = async () => {
        ...
        try {
            ...
            const deletionPromises = metricsSnapshot.docs.map(
                async (document) => {
                    await deleteDoc(
                        doc(db, "users", user.uid, "metrics", document.id)
                    );
                }
            );
                ...
                <CardContent>
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle>
                                    are you absolutely absolutely absolutely
                                    sure?
                                </AlertDialogTitle>
                                <AlertDialogDescription>
                                    this cannot be undonee! this will
                                    permanently delete all your health metrics +
                                    settings.
                                    <div className="mt-4">
